...
import { OpportunitynetworkreportRoutingModule } from './opportunitynetworkreport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitynetworkreportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule
  ]
})
export class OpportunitynetworkreportModule { }
