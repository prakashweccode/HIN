...
import { OpportunitycostandcustomerreportRoutingModule } from './opportunitycostandcustomerreport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitycostandcustomerreportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunitycostandcustomerreportModule { }
