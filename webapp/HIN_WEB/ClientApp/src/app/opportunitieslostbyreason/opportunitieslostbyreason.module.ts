...
import { OpportunitieslostbyreasonRoutingModule } from './opportunitieslostbyreason-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitieslostbyreasonRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunitieslostbyreasonModule { }
