...
@Component({
  selector: 'app-addleadreport',
  templateUrl: './addleadreport.component.html',
  styleUrls: ['./addleadreport.component.css']
})
export class AddleadreportComponent implements OnInit {
  ...
  constructor(public router: Router, public addLeadReportService: AddleadreportService, private notyHelper: NotyHelper) { }
  ...
  getLeadReportByDate() {
    ...
    this.addLeadReportService.getLeadReportByDate(this.opportunityacquisitioncost).subscribe(data => {
        if (data != null)
          this.listLead = data;
      }, err => { }, () => { });
    //}
  ...
  exportCSV() {
    ...
    console.log(csv)
    this.saveBlob(csv, "LeadReportByUser.csv");
  }
