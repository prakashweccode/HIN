...
import { WinlossbyrepRoutingModule } from './winlossbyrep-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    WinlossbyrepRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class WinlossbyrepModule { }
