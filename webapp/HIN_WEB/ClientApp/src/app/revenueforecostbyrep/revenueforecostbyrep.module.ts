...
import { RevenueforecostbyrepRoutingModule } from './revenueforecostbyrep-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    RevenueforecostbyrepRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class RevenueforecostbyrepModule { }
