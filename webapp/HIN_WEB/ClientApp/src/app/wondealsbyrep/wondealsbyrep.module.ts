...
import { WondealsbyrepRoutingModule } from './wondealsbyrep-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    WondealsbyrepRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class WondealsbyrepModule { }
