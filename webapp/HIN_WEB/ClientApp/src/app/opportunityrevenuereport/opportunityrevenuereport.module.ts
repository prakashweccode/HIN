...
import { OpportunityrevenuereportRoutingModule } from './opportunityrevenuereport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunityrevenuereportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunityrevenuereportModule { }
