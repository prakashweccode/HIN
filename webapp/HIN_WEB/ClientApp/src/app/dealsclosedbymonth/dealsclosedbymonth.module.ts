...
import { DealsclosedbymonthRoutingModule } from './dealsclosedbymonth-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    DealsclosedbymonthRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class DealsclosedbymonthModule { }
