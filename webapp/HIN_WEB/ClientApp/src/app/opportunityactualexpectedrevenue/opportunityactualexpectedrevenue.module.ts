...
import { OpportunityactualexpectedrevenueRoutingModule } from './opportunityactualexpectedrevenue-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunityactualexpectedrevenueRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunityactualexpectedrevenueModule { }
