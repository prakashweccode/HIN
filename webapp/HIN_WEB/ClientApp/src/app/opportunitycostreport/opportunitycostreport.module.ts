...
import { OpportunitycostreportRoutingModule } from './opportunitycostreport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitycostreportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunitycostreportModule { }
