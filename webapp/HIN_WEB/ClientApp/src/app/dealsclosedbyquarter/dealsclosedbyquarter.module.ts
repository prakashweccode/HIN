...
import { DealsclosedbyquarterRoutingModule } from './dealsclosedbyquarter-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    DealsclosedbyquarterRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class DealsclosedbyquarterModule { }
