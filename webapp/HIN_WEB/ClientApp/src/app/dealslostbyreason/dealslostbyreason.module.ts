...
import { DealslostbyreasonRoutingModule } from './dealslostbyreason-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    DealslostbyreasonRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class DealslostbyreasonModule { }
