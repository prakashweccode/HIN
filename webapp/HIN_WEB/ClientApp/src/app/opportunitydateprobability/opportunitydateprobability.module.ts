...
import { OpportunitydateprobabilityRoutingModule } from './opportunitydateprobability-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitydateprobabilityRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule

  ]
})
export class OpportunitydateprobabilityModule { }
