...
import { OpportunityeventreportRoutingModule } from './opportunityeventreport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunityeventreportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule
  ]
})
export class OpportunityeventreportModule { }
