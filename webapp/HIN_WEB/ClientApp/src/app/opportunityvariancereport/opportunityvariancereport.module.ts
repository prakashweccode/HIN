...
import { OpportunityvariancereportRoutingModule } from './opportunityvariancereport-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunityvariancereportRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunityvariancereportModule { }
