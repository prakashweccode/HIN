...
import { OpportunitieswonovertimeRoutingModule } from './opportunitieswonovertime-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    OpportunitieswonovertimeRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
export class OpportunitieswonovertimeModule { }
