...
import { LeadconversionRoutingModule } from './leadconversion-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    LeadconversionRoutingModule, FormsModule, ReactiveFormsModule, AssignednameModule, SfFileExplorerModule, AssignedtogridModule, NgxPaginationModule, DealgridreportModule, DealgetreportModule, CustomdropdownModule, RangeselectModule, SelectstatusModule
  ]
})
