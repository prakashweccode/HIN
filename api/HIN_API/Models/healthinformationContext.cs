...
{
    public partial class healthinformationContext : DbContext
    {
        public healthinformationContext()
        {
        }

        public healthinformationContext(DbContextOptions<healthinformationContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<CompanyEfileConfig> CompanyEfileConfig { get; set; }
        ...
        public virtual DbSet<FunnelUserList> FunnelUserList { get; set; }
        ...
        public virtual DbSet<VwCompanyRegister> VwCompanyRegister { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DEV-BCHIE;Database=healthinformation;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CompanyEfileConfig>(entity =>
            {
                ...
                entity.Property(e => e.GrantType).IsUnicode(false);
                ...
                entity.HasOne(d => d.Company)
                    .WithMany(p => p.CompanyEfileConfig)
                    .HasForeignKey(d => d.CompanyId)
                    .HasConstraintName("FK_CompanyEFileConfig_CompanyRegister");
            });
            ...
            modelBuilder.Entity<CompanyRegister>(entity =>
            {
                ...
                entity.Property(e => e.EncryptedKey).IsUnicode(false);

                entity.Property(e => e.Name).IsUnicode(false);

                entity.Property(e => e.OfflineAppKey).IsUnicode(false);

                entity.Property(e => e.State).IsUnicode(false);

                entity.Property(e => e.SupportEmail).IsUnicode(false);
            ...
            modelBuilder.Entity<ContactInformation>(entity =>
            {
                ...
                entity.Property(e => e.SecondLastName).IsUnicode(false);

                entity.Property(e => e.SecondMiddleName).IsUnicode(false);
                ...
                entity.HasOne(d => d.ContactGroupNavigation)
                    ...
                    .HasConstraintName("FK__ContactIn__Conta__318258D2");
            });
            ...
            modelBuilder.Entity<CustomerPriceList>(entity =>
            {
                entity.HasOne(d => d.Lead)
                    .WithMany(p => p.CustomerPriceList)
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK_CustomerPriceList_Lead");

                entity.HasOne(d => d.PriceList)
                    .WithMany(p => p.CustomerPriceList)
                    .HasForeignKey(d => d.PriceListId)
                    .HasConstraintName("FK_CustomerPriceList_PriceList");
            });
            ...
            modelBuilder.Entity<Deal>(entity =>
            {
                ...
                entity.HasOne(d => d.Reason)
                    ...
                    .HasConstraintName("FK__Deal__ReasonId__3B0BC30C");

                entity.HasOne(d => d.SecurityGroup)
                    .WithMany(p => p.Deal)
                    .HasForeignKey(d => d.SecurityGroupId)
                    .HasConstraintName("FK__Deal__SecurityGr__3BFFE745");
            ...
            modelBuilder.Entity<EventShow>(entity =>
            {
                ...
                entity.HasOne(d => d.EventStatus)
                    ...
                    .HasConstraintName("FK__EventShow__Event__4865BE2A");
            ...
            modelBuilder.Entity<FunnelUserList>(entity =>
            {
                entity.Property(e => e.CreatedBy).IsUnicode(false);

                entity.Property(e => e.UpdatedBy).IsUnicode(false);

                entity.HasOne(d => d.Funnel)
                    .WithMany(p => p.FunnelUserList)
                    .HasForeignKey(d => d.FunnelId)
                    .HasConstraintName("FK_FunnelUserList_Pipeline");
            });
            ...
            modelBuilder.Entity<Lead>(entity =>
            {
                ...
                entity.Property(e => e.PatientLastName).IsUnicode(false);
                ...
                entity.HasOne(d => d.SecurityGroup)
                    .WithMany(p => p.Lead)
                    .HasForeignKey(d => d.SecurityGroupId)
                    .HasConstraintName("FK__Lead__SecurityGr__5006DFF2");
            ...
            modelBuilder.Entity<LinePart>(entity =>
            {
                entity.HasOne(d => d.PartCatalog)
                    ...
                    .HasConstraintName("FK__LinePart__PartCa__6225902D");

                entity.HasOne(d => d.Quote)
                    .WithMany(p => p.LinePart)
                    .HasForeignKey(d => d.QuoteId)
                    .HasConstraintName("FK__LinePart__QuoteI__6319B466");
            });
            ...
            modelBuilder.Entity<MaterialCost>(entity =>
            {
                ...
                entity.HasOne(d => d.Product)
                    ...
                    .HasConstraintName("FK__MaterialC__Produ__640DD89F");
            });
            ...
            modelBuilder.Entity<PartCatalog>(entity =>
            {
                entity.HasOne(d => d.Quote)
                    ...
                    .HasForeignKey(d => d.QuoteId)
                    .HasConstraintName("FK__PartCatal__Quote__68D28DBC");

                entity.HasOne(d => d.UomNavigation)
                    .WithMany(p => p.PartCatalog)
                    .HasForeignKey(d => d.Uomid)
                    .HasConstraintName("FK__PartCatal__UOMId__69C6B1F5");
            });
            ...
            modelBuilder.Entity<Partner>(entity =>
            {
                ...
                entity.HasOne(d => d.ReferralDropdown)
                    ...
                    .HasConstraintName("FK__Partner__Referra__6ABAD62E");
                ...
                entity.HasOne(d => d.SecurityGroup)
                    .WithMany(p => p.Partner)
                    .HasForeignKey(d => d.SecurityGroupId)
                    .HasConstraintName("FK__Partner__Securit__6BAEFA67");
                ...
                entity.HasOne(d => d.Vendor)
                    .WithMany(p => p.Partner)
                    .HasForeignKey(d => d.VendorId)
                    .HasConstraintName("FK__Partner__VendorI__6CA31EA0");
            });
            ...
            modelBuilder.Entity<Quote>(entity =>
            {
                ...
                entity.HasOne(d => d.AssignedToNavigation)
                    ...
                    .HasConstraintName("FK__Quote__AssignedT__753864A1");

                entity.HasOne(d => d.CostCenterNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.CostCenterId)
                    .HasConstraintName("FK__Quote__CostCente__762C88DA");

                entity.HasOne(d => d.CustomerNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("FK__Quote__CustomerI__7720AD13");

                entity.HasOne(d => d.Deal)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.DealId)
                    .HasConstraintName("FK__Quote__DealId__7814D14C");

                entity.HasOne(d => d.Discount)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.DiscountId)
                    .HasConstraintName("FK__Quote__DiscountI__7908F585");

                entity.HasOne(d => d.PaymentTermsNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.PaymentTermsId)
                    .HasConstraintName("FK__Quote__PaymentTe__79FD19BE");

                entity.HasOne(d => d.StatusNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.StatusId)
                    .HasConstraintName("FK__Quote__StatusId__7AF13DF7");

                entity.HasOne(d => d.TaxNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.TaxId)
                    .HasConstraintName("FK__Quote__TaxId__7BE56230");

                entity.HasOne(d => d.TypeOfSaleNavigation)
                    .WithMany(p => p.Quote)
                    .HasForeignKey(d => d.TypeOfSaleId)
                    .HasConstraintName("FK__Quote__TypeOfSal__7CD98669");
            });
            ...
            modelBuilder.Entity<Referral>(entity =>
            {
                ...
                entity.HasOne(d => d.ReferralDropdown)
                    .WithMany(p => p.Referral)
                    .HasForeignKey(d => d.ReferralDropdownId)
                    .HasConstraintName("FK__Referral__Referr__00AA174D");
                ...
                entity.HasOne(d => d.SecurityGroup)
                    .WithMany(p => p.Referral)
                    .HasForeignKey(d => d.SecurityGroupId)
                    .HasConstraintName("FK__Referral__Securi__019E3B86");
                ...
                entity.HasOne(d => d.Vendor)
                    .WithMany(p => p.Referral)
                    .HasForeignKey(d => d.VendorId)
                    .HasConstraintName("FK__Referral__Vendor__02925FBF");
            });
            ...
            modelBuilder.Entity<Services>(entity =>
            {
                ...
                entity.HasOne(d => d.Deal)
                    ...
                    .HasForeignKey(d => d.DealId)
                    .HasConstraintName("FK__Services__DealId__093F5D4E");

                entity.HasOne(d => d.Lead)
                    .WithMany(p => p.Services)
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK_Services_Deal");
            ...
            modelBuilder.Entity<TempPatient>(entity =>
            {
                ...
                entity.Property(e => e.BloodTransfusionData).IsUnicode(false);

                entity.Property(e => e.City).IsUnicode(false);

                entity.Property(e => e.ColonoscopyData).IsUnicode(false);

                entity.Property(e => e.ContraceptionData).IsUnicode(false);

                entity.Property(e => e.DrinkAlcoholData).IsUnicode(false);

                entity.Property(e => e.EmergencyContact).IsUnicode(false);

                entity.Property(e => e.FatherHealthProblem).IsUnicode(false);

                entity.Property(e => e.FirmaDelAtencion).IsUnicode(false);
                ...
                entity.Property(e => e.Lmp).IsUnicode(false);

                entity.Property(e => e.Mamogram).IsUnicode(false);
                ...
                entity.Property(e => e.PacksPerDay).IsUnicode(false);

                entity.Property(e => e.PapSmear).IsUnicode(false);

                entity.Property(e => e.PastSurgeriesAndHospitalization).IsUnicode(false);

                entity.Property(e => e.PatientAttenSign).IsUnicode(false);
                ...
                entity.Property(e => e.Years).IsUnicode(false);

                entity.Property(e => e.YearsToQuit).IsUnicode(false);
            ...
            modelBuilder.Entity<Template>(entity =>
            {
                ...
                entity.Property(e => e.ChiefCompliant).IsUnicode(false);

                entity.Property(e => e.CreatedBy).IsUnicode(false);

                entity.Property(e => e.DraftHtml).IsUnicode(false);

                entity.Property(e => e.HistoryOfIllness).IsUnicode(false);
            ...
            modelBuilder.Entity<TemplateList>(entity =>
            {
                ...
                entity.Property(e => e.TemplatePage).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<Todo>(entity =>
            {
                ...
                entity.HasOne(d => d.Importance)
                    ...
                    .HasConstraintName("FK__Todo__Importance__1A69E950");
            ...
            modelBuilder.Entity<UserCost>(entity =>
            {
                ...
                entity.HasOne(d => d.UserCostDropdown)
                    ...
                    .HasConstraintName("FK__UserCost__UserCo__1E3A7A34");
            ...
            modelBuilder.Entity<Vendor>(entity =>
            {
                ...
                entity.HasOne(d => d.ReferralDropdown)
                    .WithMany(p => p.Vendor)
                    .HasForeignKey(d => d.ReferralDropdownId)
                    .HasConstraintName("FK__Vendor__Referral__2B947552");
                ...
                entity.HasOne(d => d.SecurityGroup)
                    .WithMany(p => p.Vendor)
                    .HasForeignKey(d => d.SecurityGroupId)
                    .HasConstraintName("FK__Vendor__Security__2C88998B");
            ...
            modelBuilder.Entity<VwCompanyRegister>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_CompanyRegister");
